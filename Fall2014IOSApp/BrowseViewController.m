...
- (void)getAllEntitysAsync
{
    ...
    BackendlessDataQuery *dataQuery = [BackendlessDataQuery query:nil where:@"comment = \'yes'" query:query];
    //dataQuery.whereClause = [NSString stringWithFormat:@"comment = \'yes'"];
